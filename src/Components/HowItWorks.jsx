...
<div className='screen-max-width'>
    ...
    <div className='flex flex-col items-center'>
        ...
        <p className='hiw-subtitle'>Its here. The biggest redesign in the 
            history of Apple GPU's</p>
    </div>
    <div className='mt-10 md:mt-20 mb-14'>
        ...
        <p className='text-gray font-semibold text-center mt-3'>Honkai: 
            Star Rail</p>
        </div>
        <div className='hiw-text-container'>
                <div className='flex flex-1 justify-center flex-col'>
                  <p className='hiw-text g_fadeIn'>
                    A17Pro is an entirely new class of iPhone chip that 
                    delivers our {''}
